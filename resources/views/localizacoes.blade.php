    ...
    <main>
        ...
        <section class="mt-2 relative h-[45vh]">
            <div class="container mx-auto px-4 py-8">
                ...
                @if (empty($cidades))
                    <div class="text-center text-gray-600">Não há propriedades nesta localização</div>
                @else
                    @if (count($cidades) === 1)
                        <div class="flex justify-center">
                            <div class="bg-white rounded-xl p-6 text-center">
                                <h1 class="text-3xl font-bold text-gray-800">{{ $cidades[0] }}</h1>
                            </div>
                        </div>
                    @else
        ...
        <div id="propertyModal"
            ...
            <div class="bg-white rounded-lg p-8 max-w-2xl w-full mx-4">
                ...
                <p id="modalPreco"
                    class="text-2xl font-bold text-purple-light mb-4 flex items-center justify-center ">
                </p>
