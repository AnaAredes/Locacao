...
<body>
    <div class="container">
        ...
        <div class="info">
            <span class="label">Hóspede:</span> {{ $clientName }}
        </div>
        ...
        <div class="info">
            <span class="label">Número de Quartos:</span> {{ $detalhes->numero_quartos }}
        </div>

        <div class="info">
            <span class="label">Por noite:</span> €{{ number_format($detalhes->preco_diario, 2, ',', '.') }}
        </div>
        ...
        <div class="info">
            <span class="label">Datas de Check-in e Check-out:</span> {{\Carbon\Carbon::parse($reserva->data_inicio)->format('d/m/Y') }} - {{\Carbon\Carbon::parse($reserva->data_fim)->format('d/m/Y')}}
        </div>
